 ...
 */
final class Version20180802093446 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE closing (id INT AUTO_INCREMENT NOT NULL, closing_type_id INT NOT NULL, closing_date DATE NOT NULL, INDEX IDX_5542EBB4507CAC82 (closing_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE closing_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE job_offer ADD closing_id INT DEFAULT NULL');
